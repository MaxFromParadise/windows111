(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        const credit = document.querySelector(".window-credit__span1");
        const middlePrice = document.querySelector(".window-credit__span2");
        function updateValues() {
            heightValue.textContent = heightSlider.value;
            widthValue.textContent = widthSlider.value;
            const basePrice = 6062;
            const price = basePrice + (heightSlider.value - 150) * 10 + (widthSlider.value - 150) * 10;
            middlePrice.textContent = price + 2062 + "р";
            credit.textContent = Math.round(price / 12) + "р";
            priceValue.textContent = price;
        }
        heightSlider.oninput = updateValues;
        widthSlider.oninput = updateValues;
        updateValues();
    }));
